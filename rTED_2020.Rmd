...
- packages that wrap JavaScript libraries and make them accessible in R
- DT (DataTables)
- leaflet (Leaflet)
- others
...
shinyapps.io
- access to database - separate data from the file
- lock down so it can only be accessed by people specifically given access.
- custom URLs / redirects
